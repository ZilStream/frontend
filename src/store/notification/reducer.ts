...
import { NotificationAddProps, NotificationRemoveProps, NotificationState, NotificationStateProps } from "./types";
...
const reducer = (state: NotificationState = initialState, action: AnyAction) => {
  ...
  switch(action.type) {
    ...
    case NotificationActionTypes.REMOVE_NOTIFICATION:
      ...
      return {
        ...state,
        notifications: state.notifications.filter(notification => notification.hash !== removeProps.notification.hash)
      }
