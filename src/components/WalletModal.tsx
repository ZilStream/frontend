    ...
    <Transition show={isOpen} as={Fragment}>
      <Dialog initialFocus={zilPayButtonRef} open={isOpen} onClose={() => setIsOpen(false)} className="fixed z-10 inset-0 overflow-y-auto">
        ...
        <div className="flex items-center justify-center min-h-screen">
          ...
          >
            <div className="relative bg-white dark:bg-gray-900 border dark:border-gray-800 p-12 rounded-lg shadow-lg max-w-md mx-auto text-center">
