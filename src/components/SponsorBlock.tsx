...
const SponsorBlock = (props: Props) => {
  ...
  return (
    <a href={`${link ?? ""}?ref=zilstream`} target="_blank">
      <div
        className={`h-48 rounded-xl py-2 px-3 shadow bg-white dark:bg-gray-800 text-white dark:text-white relative flex flex-col bg-center bg-cover bg-[url('https://zilstream.b-cdn.net/sponsorships/plunderswap_staking.gif')]`}
      >
        <div className="mb-2">
        ...
        <div className="flex flex-col items-start justify-end h-full gap-4 text-sm -mt-1">
          <div className="flex items-center text-xs text-gray-400 dark:text-gray-400">
            ...
            <Tippy
              content={
                <div className="bg-white dark:bg-gray-700 border dark:border-gray-800 px-4 py-3 rounded-lg shadow-md text-sm">
                  ZilStream sponsorships directly support the ongoing
                  development and maintenance costs of the site.
                </div>
              }
            >
