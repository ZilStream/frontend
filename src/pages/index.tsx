...
function Home({
  ...
  useEffect(() => {
    ...
    if (currentSort === SortType.APR || currentSort === SortType.APY) {
      ...
      tokensToDisplay.sort((a, b) => {
        if (currentSortDirection == SortDirection.Ascending) {
          return a.market_data.change_percentage_24h >
            b.market_data.change_percentage_24h
            ? 1
            : -1;
        }
        return a.market_data.change_percentage_24h <
      ...
      tokensToDisplay.sort((a, b) => {
        if (currentSortDirection == SortDirection.Ascending) {
          return a.market_data.change_percentage_7d >
            b.market_data.change_percentage_7d
            ? 1
            : -1;
        }
        return a.market_data.change_percentage_7d <
      ...
      tokensToDisplay.sort((a, b) => {
        if (currentSortDirection == SortDirection.Ascending) {
          return a.market_data.change_percentage_24h_zil >
            b.market_data.change_percentage_24h_zil
            ? 1
            : -1;
        }
        return a.market_data.change_percentage_24h_zil <
      ...
      tokensToDisplay.sort((a, b) => {
        if (currentSortDirection == SortDirection.Ascending) {
          return a.market_data.change_percentage_7d_zil >
            b.market_data.change_percentage_7d_zil
            ? 1
            : -1;
        }
        return a.market_data.change_percentage_7d_zil <
      ...
      tokensToDisplay.sort((a, b) => {
        if (currentSortDirection == SortDirection.Ascending) {
          return a.market_data.daily_volume_usd > b.market_data.daily_volume_usd
            ? 1
            : -1;
        }
        return a.market_data.daily_volume_usd < b.market_data.daily_volume_usd
      ...
      tokensToDisplay.sort((a, b) => {
        if (currentSortDirection == SortDirection.Ascending) {
          return a.market_data.current_liquidity_usd >
            b.market_data.current_liquidity_usd
            ? 1
            : -1;
        }
        return a.market_data.current_liquidity_usd <
      ...
      tokensToDisplay.sort((a, b) => {
        if (currentSortDirection == SortDirection.Ascending) {
          return a.market_data.current_supply > b.market_data.current_supply
            ? 1
            : -1;
        }
        return a.market_data.current_supply < b.market_data.current_supply
      ...
      tokensToDisplay.sort((a, b) => {
        if (currentSortDirection == SortDirection.Ascending) {
          return a.market_data.total_supply > b.market_data.total_supply
            ? 1
            : -1;
        }
      ...
      tokensToDisplay.sort((a, b) => {
        if (currentSortDirection == SortDirection.Ascending) {
          return a.market_data.fully_diluted_valuation_usd <
            b.market_data.fully_diluted_valuation_usd
            ? 1
            : -1;
        }
        return a.market_data.fully_diluted_valuation_usd <
      ...
      tokensToDisplay.sort((a: Token, b: Token) => {
        if (currentSortDirection == SortDirection.Ascending) {
          return a.market_data.market_cap_usd > b.market_data.market_cap_usd
            ? 1
            : -1;
        }
        return a.market_data.market_cap_usd < b.market_data.market_cap_usd
  ...
  return (
    <>
      <Head>
        <title>
          $uperChain ecosystem prices, charts, and market cap | GSCxBT.com
        </title>
        <meta
          property="og:title"
          content="$uperChain ecosystem prices, charts, and market cap | GSCxBT.com"
        />
        <meta
          name="description"
          content="$uperChain ecosystem prices and charts, listed by market capitalization. Free access to current and historic data for gUSD, XBTA, GSC and many more."
        />
        <meta
          ...
          <div className="flex-grow">
            ...
            <div className="text-gray-600 dark:text-gray-400">
              ...
              <span className="font-semibold">
                {currencyFormat(
                  marketCap * selectedCurrency.rate,
              ...
              in volume over the last 24 hours on GSC20 $uperChain.
            </div>
            <div className="sr-only">
              $uperChain is currently tracking {tokens.length} tokens. Popular
              trends within GSC20 right now are NFT and DeFi.
            </div>
          </div>
        </div>
      </div>
          ...
          {tokenState.initialized === false ? (
            ...
            <>
              ...
              <RatesBlock
                ...
                subTitle={`MC ${compactFormat(
                  zilToken.market_data.current_supply * selectedCurrency.rate,
                  selectedCurrency.symbol
                )}`}
                token={tokens.filter((token) => token.symbol == "GSC")[0]}
          ...
          <div className="flex-grow flex items-stretch">
            <div className="flex items-center border-r border-gray-200 dark:border-gray-800 pr-3 mr-3">
              <button
                ...
                className={`${
                  currentList == ListType.Favorites
          ...
          >
            <tr className="py-2">
              ...
              <th className="text-left pl-2 sm:pl-3 pr-1 sm:pr-2 py-2">
                <button
                  className="focus:outline-none font-bold inline-flex items-center"
              ...
              <th className="px-2 py-2 text-left sticky left-0 z-10">
                <button
                  className="focus:outline-none font-bold inline-flex items-center"
                  onClick={() => handleSort(SortType.Token)}
                >
                  Token
              ...
              {settingsState.columns.priceFiat && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center"
                    onClick={() => handleSort(SortType.PriceFiat)}
                  >
                    {currentSort === SortType.PriceFiat && (
                      <Triangle
                        className={`mr-1 ${
              ...
              {settingsState.columns.ath && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center"
                    onClick={() => handleSort(SortType.ATH)}
                  >
              ...
              {settingsState.columns.atl && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center"
                    onClick={() => handleSort(SortType.ATL)}
                  >
              ...
              {settingsState.columns.change24H && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center"
                    onClick={() => handleSort(SortType.Change24H)}
                  >
              ...
              {settingsState.columns.change7D && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center"
                    onClick={() => handleSort(SortType.Change7D)}
                  >
              ...
              {settingsState.columns.change24HZIL && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center"
                    onClick={() => handleSort(SortType.Change24HZIL)}
                  >
              ...
              {settingsState.columns.change7DZIL && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center"
                    onClick={() => handleSort(SortType.Change7DZIL)}
                  >
              ...
              {settingsState.columns.marketCap && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center whitespace-nowrap"
                    onClick={() => handleSort(SortType.MarketCap)}
                  >
              ...
              {settingsState.columns.marketCapDiluted && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center whitespace-nowrap"
                    onClick={() => handleSort(SortType.FullyDilutedMarketCap)}
                  >
              ...
              {settingsState.columns.circSupply && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center whitespace-nowrap"
                    onClick={() => handleSort(SortType.CircSupply)}
                  >
              ...
              {settingsState.columns.totalSupply && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center whitespace-nowrap"
                    onClick={() => handleSort(SortType.TotalSupply)}
                  >
              ...
              {settingsState.columns.maxSupply && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center whitespace-nowrap"
                    onClick={() => handleSort(SortType.MaxSupply)}
                  >
              ...
              {settingsState.columns.liquidity && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center"
                    onClick={() => handleSort(SortType.Liquidity)}
                  >
              ...
              {settingsState.columns.volume && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center whitespace-nowrap"
                    onClick={() => handleSort(SortType.Volume)}
                  >
              ...
              {settingsState.columns.apr && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center whitespace-nowrap"
                    onClick={() => handleSort(SortType.APR)}
                  >
              ...
              {settingsState.columns.apy && (
                <th className="px-2 py-2 text-right">
                  <button
                    className="focus:outline-none font-bold inline-flex items-center whitespace-nowrap"
                    onClick={() => handleSort(SortType.APY)}
                  >
