...
function Portfolio() {
  return (
    <>
      ...
      <div className="bg-white p-10 rounded-lg max-w-3xl mx-auto text-lg">
        ...
        <ul className="list-disc ml-6 mb-6">
          ...
          <li>Private sale (20%): <strong>4,000,000</strong> (Vested quarterly over 12 months, closed and led by ZILHive)</li>
